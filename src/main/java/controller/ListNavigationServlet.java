...
public class ListNavigationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
				...
				String act = request.getParameter("doThisToFlight");
				...
				if (act == null) {
					...
					try {
						...
						FlightTrackerHelper daoForItems = new FlightTrackerHelper();
						
						request.setAttribute("allItems", daoForItems.showAllFlights());
									
						if(daoForItems.showAllFlights().isEmpty()){
